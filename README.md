...
- **Sistema de etapas:** cada etapa mide su progreso como la **ganancia neta desde que entraste a esa etapa**, contra el **objetivo en $** de esa etapa.
  - **Fondeo CFD, Fondeo Futuros:** avance **automático con confirmación de fechas** — al superar el objetivo, pides las fechas de cierre e inicio de la siguiente etapa, se archiva el resumen de la fase cerrada, **se reinician el capital y las estadísticas** (la nueva fase arranca en 0 de progreso y solo cuenta los trades de esa fase) y aparece el modal de celebración. En CFD, tras las fases el programa pasa a la etapa terminal **«Fondeada»**; en Futuros, a **«Fondeo»**.
  ...
  - **Historial de fases:** las fases completadas quedan guardadas (fechas, balance de entrada/salida, P&L, operaciones, win rate y profit factor) y se pueden volver a ver seleccionándolas en «Etapas» o en el selector de fase del Dashboard.
  - **Corrección de fase:** si una cuenta avanzó antes de reiniciar capital/estadísticas (datos antiguos), la pestaña «Etapas» ofrece reponer el capital de entrada y corregir el avance (incluido volver atrás si se saltó una fase), saneando el historial.
